...
<style>
  ...
  /* Animaciones */
  .fade-enter{ animation:fadeIn .5s var(--ease-out-expo) forwards; }
  @keyframes fadeIn{
  ...
  .tab-btn:hover{ color:var(--brand-red); background-color:var(--brand-red-light); }
  .tab-btn::after{
    content:'';
    position:absolute;
    bottom:-2px;
  ...
  .tab-btn.active{ color:var(--brand-red); background-color:var(--brand-red-light); }
  ...
  /* IMAGEN DE SEDE (FRAME UNIFORME, SIN APLASTARSE) */
  .sede-img-box{
    width:100%;
    position:relative;
    overflow:hidden;
  ...
  /* Opcional: si alguna foto se recorta raro */
  ...
  .sede-card:hover .icon-box{
    ...
    box-shadow:0 10px 20px -5px rgba(239,35,60,.4);
  }
  ...
  /* Ajustes para que no se vea comprimido */
  @media (min-width: 1024px){
    .layout-cols{
      align-items:stretch; /* iguala alturas visualmente */
    }
  }
  @media (max-width: 1024px){
    .sede-img-box{ max-height:320px; }
  }
...
<div class="container mx-auto px-6 py-12 min-h-[80vh]">
  ...
  <div class="layout-cols flex flex-col lg:flex-row gap-8 lg:gap-16 items-start">
    ...
    <div class="w-full lg:w-1/3">
      ...
      <div id="info-arequipa" class="sede-info fade-enter">
        <div class="sede-card bg-white dark:bg-gray-800 p-8 rounded-3xl shadow-xl shadow-gray-200/50 dark:shadow-none">
          ...
          <div class="sede-img-box">
            <img src="{{ asset('img/sedes/sede_arequipa.png') }}" alt="Sede Arequipa">
          </div>
          ...
          <div class="space-y-6">
            ...
            <div class="flex gap-4 group">
              ...
              <div>
                ...
                <p class="text-gray-800 dark:text-gray-200 font-medium text-lg">931 315 933</p>
              </div>
            </div>
          </div>
      ...
      <div id="info-tacna" class="sede-info hidden">
        <div class="sede-card bg-white dark:bg-gray-800 p-8 rounded-3xl shadow-xl shadow-gray-200/50 dark:shadow-none">
          ...
          <div class="sede-img-box">
            {{-- Si se recorta raro, prueba class="img-top" --}}
          ...
          <div class="space-y-6">
            ...
            <div class="flex gap-4 group">
              ...
              <div>
                <p class="text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-widest mb-1">Contacto</p>
                <p class="text-gray-800 dark:text-gray-200 font-medium text-lg">921 810 356</p>
              </div>
            </div>
          </div>
        ...
        <div class="sede-card bg-white dark:bg-gray-800 p-8 rounded-3xl shadow-xl shadow-gray-200/50 dark:shadow-none">
          ...
          <div class="space-y-6">
            ...
            <div class="flex gap-4 group">
              ...
              <div>
                <p class="text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-widest mb-1">Contacto</p>
                <p class="text-gray-800 dark:text-gray-200 font-medium text-lg">976 156 196</p>
              </div>
            </div>
          </div>
    ...
    <div class="w-full lg:w-2/3 map-container relative rounded-3xl overflow-hidden shadow-2xl bg-gray-100 dark:bg-gray-800"
         style="min-height: 680px;">
      <iframe id="map-frame"
              class="w-full h-full min-h-[680px]"
              ...
              style="border:0; opacity:1; transition:opacity .5s ease;"
              allowfullscreen=""
              loading="lazy"
...
<script>
  ...
  function switchSede(sedeId){
    ...
    if(selectedInfo){
      ...
      void selectedInfo.offsetWidth; // reflow
